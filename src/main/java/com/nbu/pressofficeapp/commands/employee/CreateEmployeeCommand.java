...
public class CreateEmployeeCommand extends BaseCommand {
    ...
    public static final String PERSON_CREATED = "Person with a name %s and id %d was created.";
    ...
    private String createEmployee(List<String> parameters) {
        ...
        Employee newEmployee = getPressOfficeRepository().createEmployee(name, salary);


        return String.format(PERSON_CREATED, name, newEmployee.getId());
